...
/**
 * Outside-world surface for the doctor commands, behind one injectable
 * interface — same shape as the other tools, so tests supply fakes (captured
 * output, a mock client) with no real I/O.
 */
